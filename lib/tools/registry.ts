...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    name: "給与手取り計算",
    description: "年収から所得税、住民税、社会保険料を考慮した月の手取り額を概算します。",
    category: "work",
    categoryName: "給与・税金",
    keywords: ["給与手取り計算", "給料 手取り 計算", "年収 手取り", "月の手取り"],
    popular: true,
  },
  {
  ...
  },
  {
    slug: "mortgage",
    name: "住宅ローン計算",
    description: "借入金額、金利、返済期間から毎月の住宅ローン返済額を計算します。",
    category: "life",
    categoryName: "生活・交通",
  ...
  },
  {
    ...
    name: "家賃初期費用計算",
    description: "敷金・礼金・仲介手数料を含む賃貸契約時の初期費用を概算します。",
    category: "life",
    categoryName: "生活・交通",
