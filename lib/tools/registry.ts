...
export const tools: Tool[] = [
  { slug: "take-home-pay", name: "手取り計算", description: "年収・月収から所得税、住民税、社会保険料などを考慮した手取り額の目安を計算します。", category: "work", categoryName: "給与・税金", keywords: ["手取り計算", "給料 手取り", "年収 手取り", "給与計算"], popular: true },
  { slug: "income-tax", name: "所得税計算", description: "給与収入から所得税の目安を計算します。給与所得控除・基礎控除を考慮した簡易計算です。", category: "work", categoryName: "給与・税金", keywords: ["所得税", "所得税計算", "給与所得", "税金"], popular: true },
  { slug: "resident-tax", name: "住民税計算", description: "前年の所得をもとに住民税の目安を確認できます。", category: "work", categoryName: "給与・税金", keywords: ["住民税", "住民税計算", "市民税", "県民税"], popular: true },
  { slug: "social-insurance", name: "社会保険料計算", description: "標準報酬月額をもとに健康保険・厚生年金などの負担額の目安を計算します。", category: "work", categoryName: "給与・税金", keywords: ["社会保険", "社会保険料", "健康保険", "厚生年金"], popular: true },
  { slug: "overtime-pay", name: "残業代計算", description: "時給と残業時間から残業代の目安を計算します。割増率を指定できます。", category: "work", categoryName: "給与・税金", keywords: ["残業代", "残業代計算", "割増賃金", "時間外労働"], popular: true },
  { slug: "hourly-wage", name: "時給計算", description: "月給と勤務時間から実質時給を計算します。月収から時給を知りたいときに便利です。", category: "work", categoryName: "給与・税金", keywords: ["時給計算", "時給", "月給 時給", "給与"], popular: true },
...
export const categories = [
  { slug: "work", name: "給与・税金", description: "給与、税金、社会保険、残業など仕事とお金に関する計算ツール。" },
  { slug: "date", name: "日付・時間", description: "年齢、日付差、営業日など日付に関する便利なツール。" },
  { slug: "money", name: "お金・節約", description: "消費税、割引、割り勘など日常のお金を計算するツール。" },
  { slug: "life", name: "生活・交通", description: "ガソリン代や電気代など生活にかかる費用を計算するツール。" },
  { slug: "developer", name: "IT・開発者", description: "開発作業で使えるオンラインユーティリティ。" }
];
