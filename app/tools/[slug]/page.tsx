  ...
  if (!tool)
    return (
      <main className="mx-auto max-w-4xl px-5 py-16">
        <h1 className="text-3xl font-bold">ツールが見つかりません</h1>
      </main>
    );
  return (
    <main className="mx-auto max-w-4xl px-5 py-10">
      ...
      <div className="mt-6">
        ...
        <h1 className="mt-4 text-3xl font-black md:text-4xl">{tool.name}</h1>
      ...
      <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-6">
        <h2 className="text-xl font-bold">このツールについて</h2>
        <p className="mt-3 text-sm leading-7 text-muted">
          入力したデータはこのページ上で計算され、サーバーへ送信されません。計算結果は目安としてご利用ください。
        </p>
        <h2 className="mt-7 text-xl font-bold">よくある質問</h2>
        <h3 className="mt-4 font-bold">無料で使えますか？</h3>
        <p className="mt-2 text-sm leading-6 text-muted">
          はい。現在公開しているツールは無料で利用できます。
        </p>
      </section>
    </main>
  );
